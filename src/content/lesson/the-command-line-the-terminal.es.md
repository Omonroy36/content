...
+ Como desarrollador, es lo único que necesitas tener disponible. Las computadoras no vienen con Atomo, Sublime text (o cualquier otro IDE de lujo). A veces - como los servidores de producción - no se le permite instalar nada y **el sistema ni siquiera tiene una interfaz visual** - solo la línea de comandos.
